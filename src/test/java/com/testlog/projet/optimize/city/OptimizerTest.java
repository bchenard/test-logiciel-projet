...
public class OptimizerTest {
    ...
    public void testSolve_calls() {
        ...
        when(cityOptimizer.optimize(anyString(), anyInt(), anyInt(), anyDouble(), any(), any(), any())).thenReturn(cityTrip);
        ...
        verify(cityOptimizer).optimize(anyString(), anyInt(), anyInt(), anyDouble(), any(), any(), any());
    ...
    public void testSolve_noHotel_shouldReturnOnlyTransport() {
        ...
        when(cityOptimizer.optimize(anyString(), anyInt(), anyInt(), anyDouble(), any(), any(), any())).thenReturn(null);
